...
using VocalClerk.Infrastructure.Services;
...
builder.Services.AddDbContext<VocalClerkDbContext>(options =>
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "VocalClerk API v1");
