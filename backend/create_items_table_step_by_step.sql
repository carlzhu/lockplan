...
-- Step 2: 添加外键约束
ALTER TABLE `items` 
ADD CONSTRAINT `FK_items_items_parent_id` 
FOREIGN KEY (`parent_id`) REFERENCES `items` (`id`) ON DELETE RESTRICT;

ALTER TABLE `items` 
ADD CONSTRAINT `FK_items_users_user_id` 
FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

-- Step 3: 创建 item_tags 表
